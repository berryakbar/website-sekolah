...
<body>
    ...
    <div class="container" style="margin-top: 0px; margin-bottom: 50px;">
        <center><img src="img/camera.png" width="100px"><br>
            <h3>Galeri Foto</h3><hr>
        </center>
        <div class="row">
            <?php 
                include 'koneksi.php';
                $sql="SELECT * FROM galeri_foto ORDER BY id_foto DESC";
                $query=mysqli_query($conn,$sql);
                while( $data=mysqli_fetch_assoc($query)) { ?>
                <div class="col-md-2" style="margin: 10px; padding-top: 20px; padding-bottom: 20px; border: 3px inset #303f8f; background-color: #fff; font-size: 10px; border-radius: 30px;" >
                <center>
